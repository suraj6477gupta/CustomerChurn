...
model = pickle.load(open(r"C:\Users\91808\Desktop\python projects\customerChurn_NEW\model.pkl", 'rb'))
preprocessor = pickle.load(open(r"C:\Users\91808\Desktop\python projects\customerChurn_NEW\preprocessor.pkl", 'rb'))
